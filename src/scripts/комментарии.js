...
// event.preventDefault(); // - .preventDefault() в JS используется для отмены действия по умолчанию (в данном случае для отмены автоматического обновления страницы при нажатии на кнопку)
